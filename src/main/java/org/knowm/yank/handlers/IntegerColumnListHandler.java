...
public class IntegerColumnListHandler extends ColumnListHandler<Integer> {
   ...
   * <code>handle()</code>.
   */
  public IntegerColumnListHandler() {
    this(1, null);
  }
   ...
   */
  public IntegerColumnListHandler(int columnIndex) {
   ...
   */
  public IntegerColumnListHandler(String columnName) {
    this(1, columnName);
  }
   ...
   * @param columnName The name of the column to retrieve from the <code>ResultSet</code>.
   */
  private IntegerColumnListHandler(int columnIndex, String columnName) {
    super();
